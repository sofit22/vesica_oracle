  ...
  >
    <defs>
      <radialGradient id="bgG" cx="50%" cy="45%" r="60%">
        <stop offset="0%" stopColor="#1a1015" />
    ...
    {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((a) => (
      <line
        key={a}
        x1={100 + Math.cos((a * Math.PI) / 180) * 20}
        y1={150 + Math.sin((a * Math.PI) / 180) * 20}
        x2={100 + Math.cos((a * Math.PI) / 180) * 68}
        y2={150 + Math.sin((a * Math.PI) / 180) * 68}
        stroke="#c9a84c"
        strokeWidth="0.2"
        opacity="0.2"
      />
  ...
  >
   ...
   {card.imgUrl ? (
        ...
        <>
          ...
          <div
            style={{
              fontFamily: "'redaction',sans-serif",
              fontSize: 10,
              letterSpacing: 4,
...
const ExpandedCard = ({ card, meaning, onClose, show }) => {
  useEffect(() => {
    ...
    if (show) root.style.overflow = "hidden";
    ...
    >
      <div
        ...
        style={{
          ...
          transition:
            "transform 0.35s ease, border-color 0.3s, box-shadow 0.3s",
        }}
      >
        <CardBackSVG />
      </div>
...
export default function TarotApp() {
  const [activeCards, setActiveCards] = useState(() =>
    [...TAROT_DECK].sort(() => Math.random() - 0.5).slice(0, 6),
  );
  ...
  return (
    ...
    >
      <link rel="stylesheet" href="https://use.typekit.net/mrc1ksp.css" />
      <link
        href="https://fonts.googleapis.com/css2?family=Neue+Haas+Grotesk:wght@400;500;700&display=swap"
        rel="stylesheet"
      />
      ...
      <div
        style={{
          ...
          height: 600,
          background:
            "radial-gradient(ellipse,rgba(107,29,42,0.15) 0%,transparent 70%)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      />
      ...
      >
        <div
          style={{ marginBottom: 50, animation: "fadeUp 1.2s ease forwards" }}
        >
          <div
            style={{
              fontFamily: "'redaction',sans-serif",
          ...
          >
            Elegí una carta y descubrí qué tiene el universo para decirte
          </p>
          <div
            style={{
              width: 60,
              ...
              margin: "20px auto 0",
              background:
                "linear-gradient(90deg,transparent,#8a7433,transparent)",
            }}
          />
        </div>
        ...
        <div style={{ marginTop: 50, animation: "fadeUp 1s ease 1.5s both" }}>
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.boxShadow = "0 0 20px rgba(201,168,76,0.15)";
              e.target.style.background = "rgba(201,168,76,0.05)";
            }}
            onMouseLeave={(e) => {
              e.target.style.borderColor = "#8a7433";
              e.target.style.color = "#8a7433";
        ...
        <p
          style={{
            marginTop: 60,
            fontSize: 13,
            color: "rgba(168,154,130,0.4)",
            fontStyle: "italic",
            letterSpacing: 1,
            animation: "fadeUp 1s ease 1.8s both",
          }}
        >
          Las cartas reflejan energías, no destinos. Tu corazón siempre elige.
        </p>
      </div>
